...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-contact {
      background: 
                   url('SerHead/head4.png') no-repeat;
...
<div class="faq-item">
            <h4><i class="fas fa-question-circle"></i>Proposez-vous des contrats de gestion et d'infogérance pour le réseau électrique d'une entreprise ?</h4>
            <p> Oui, absolument. REGILEC propose des contrats d'infogérance et de gestion globale sur mesure avec une formule de facturation mensuelle. En confiant l'intégralité de votre supervision électrique à nos ingénieurs, vous externalisez vos contraintes techniques tout en sécurisant votre outil de production.
              Nous assurons une maintenance préventive continue, le suivi de vos tableaux généraux (TGBT), la régulation en temps réel de vos équipements et l'optimisation stricte de votre consommation. Ce partenariat contractuel nous permet de vous garantir un succès total : maintien d'une performance réseau optimale, continuité de service maximale, zéro panne d'origine harmonique et élimination définitive de toutes les pénalités de puissance réactive.
            </p>
          </div>


          <div class="faq-item">
            <h4><i class="fas fa-question-circle"></i>Comment demander une étude ?</h4>
            <p>Contactez-nous par téléphone, par e-mail ou via notre formulaire en ligne. Nos ingénieurs vous rappelleront sous 24h pour planifier un premier échange technique autour de votre réseau.</p>
          </div>
          <div class="faq-item">
            <h4><i class="fas fa-question-circle"></i> Quels sont les délais d'intervention ?</h4>
            <p>Selon l'envergure de votre infrastructure, nos délais de fabrication, de livraison et de mise en service sur site s'étendent généralement de 5 à 30 jours après la validation technique.</p>
          </div>
          
        </div>
        <div class="col-md-6">
          <div class="faq-item">
            <h4><i class="fas fa-question-circle"></i> Vos installations sont-elles garanties ?</h4>
            <p>Absolument. Tous les équipements installés par nos soins bénéficient d'une garantie totale de 6 à 12 mois (pièces et main-d'œuvre), adossée à 3 mois de maintenance préventive gratuite après mise en service.</p>
          </div>
          <div class="faq-item">
            <h4><i class="fas fa-question-circle"></i> Comment garantissez-vous la suppression des pénalités SENELEC ?</h4>
            <p>Nos solutions de compensation réactive sont dimensionnées sur mesure à partir de vos relevés précis. Nous garantissons contractuellement un redressement de votre facteur de puissance cos phi 0,95, éliminant ainsi 100% des pénalités pour consommation réactive.</p>
          </div>
          <div class="faq-item">
            <h4><i class="fas fa-question-circle"></i> Proposez-vous des devis gratuits ?</h4>
            <p>Oui, nos audits préliminaires, l'analyse de vos factures et l'établissement de nos propositions techniques et financières sont entièrement gratuits et sans engagement pour les professionnels.</p>
          </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 mb-2">
          ...
          <p class="small opacity-75">Votre partenaire événementiel à Saint-Louis depuis 10 ans.</p>
          <div class="small">
        ...
        <div class="col-lg-4 mb-2">
          ...
          <p class="small opacity-75 mb-0">© BCM-GROUPE Sénégal - Tous droits réservés</p>
        </div>
      </div>
    </div>
  </footer>
  ...
  <script>
    function sendViaWhatsApp(event) {
      ...
      let whatsappMessage = `*Nouvelle demande de contact - regilec*%0A%0A`;
